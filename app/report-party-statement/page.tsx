...
export default function ReportPartyStatement() {
    const router=useRouter()
  return (
    <DynamicTable
      title={{
        text: "Party Statement (Ledger)",
      ...
      filters={[
        ...
        {
          label: "Search Party by Name or Number",
          width: "11rem",
          component:<Select menus={["Search Party by Name or Number","Abc","Cash Sale","Xyz"]}/>,
          icon: null,
