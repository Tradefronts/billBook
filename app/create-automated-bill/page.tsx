...
const CreateAutomatedBill = () => {
  return (
    <div className="w-full h-full">
      <Header name="Create Automated Sales Invoice" />
      <div className="w-full  px-5">
        <div className="border w-full ">
          <span className="block py-4 px-3 border-b border-gray-300 text-xs text-gray-700">
            Schedule Details
          </span>
          <div className="px-3 py-5 flex items-center gap-5">
            <div>
